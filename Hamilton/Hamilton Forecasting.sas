ods pdf file="/home/natdanjones0/Hamilton/Hamilton Forecasting.pdf";
options center;
options orientation=portrait;

title1 height=22pt "Emilia Romagna Grand Prix, 2021";
title2 height=14pt " ";
title3 height=18pt "Forecasting Lewis Hamilton's Next 5 Lap Times";
...
proc sort data=WORK.Hamilton out=HamiltonForecast;
	by lap;
run;

 proc arima data=WORK.HamiltonForecast plots
