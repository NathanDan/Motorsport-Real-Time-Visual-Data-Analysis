ods pdf file="/home/natdanjones0/Tsunoda/Tsunoda Forecasting.pdf";
options center;
options orientation=portrait;

title1 height=22pt "Emilia Romagna Grand Prix, 2021";
title2 height=14pt " ";
title3 height=18pt "Forecasting Yuki Tsunoda's Next 5 Lap Times";
...
proc sort data=WORK.Tsunoda out=TsunodaForecast;
	by lap;
run;

 proc arima data=WORK.TsunodaForecast plots
