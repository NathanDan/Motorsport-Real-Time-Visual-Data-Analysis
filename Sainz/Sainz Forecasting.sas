ods pdf file="/home/natdanjones0/Sainz/Sainz Forecasting.pdf";
options center;
options orientation=portrait;

title1 height=22pt "Emilia Romagna Grand Prix, 2021";
title2 height=14pt " ";
title3 height=18pt "Forecasting Carlos Sainz's Next 5 Lap Times";
...
proc sort data=WORK.Sainz out=SainzForecast;
	by lap;
run;

 proc arima data=WORK.SainzForecast plots
